#GENERAL STEPS
#Extracting  household power data to Power variable
power <- read.table("household_power_consumption.txt",skip=1,sep=";")

#Assigning column names to Power Table.
names(power) <- c("Date","Time","Global_active_power","Global_reactive_power","Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3")

#Subsetting Power table for dates between 01/02/2007, and 02/02/2007
...
# initiating a composite plot with FOUR graphs
par(mfrow=c(2,2))
